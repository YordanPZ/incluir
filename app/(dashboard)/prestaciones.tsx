          ...
          <View className="flex-row justify-between items-center">
            <View>
              ...
              {isFromCache && !isOffline && (
                <Text variant="small" style={styles.cacheIndicator}>
                  📦 Datos en cache
                </Text>
              )}
            </View>
            ...
            prestacionesPendientes.map((prestacion) => (
              ...
              >
                ...
                <CardContent className="pt-0">
                  ...
                  {/* Dev Mode Badges */}
                  {isDevMode && (settings.skipTimeValidation || settings.skipLocationValidation) && (
                    <>
                  ...
                  <View className="flex-row gap-2 items-center">
                    ...
                    >
                      <View className="flex-row items-center gap-1">
                        ...
                        <Text className="text-xs text-muted-foreground">Llamar</Text>
                      </View>
                    </Button>
                    ...
                    <Button
                      ...
                      size="sm"
                      className="flex-1"
                      onPress={() => abrirMapa(prestacion.ubicacion_paciente_lat, prestacion.ubicacion_paciente_lng)}
                    >
                      <View className="flex-row items-center gap-1">
                        <MapPin size={14} color="#6b7280" />
                        <Text className="text-xs text-muted-foreground">Mapa</Text>
                      </View>
                    </Button>
                    ...
                    <Button
                      ...
                      disabled={!puedeCompletarPrestacion(prestacion.fecha)}
                    >
