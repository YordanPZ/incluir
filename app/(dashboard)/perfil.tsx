...
import { User, Mail, Phone, CreditCard, Lock, LogOut, Settings } from 'lucide-react-native';
        ...
        >
            ...
            <Card style={styles.avatarCard}>
                <CardContent style={styles.avatarContent}>
                    ...
                    />
                    <Text variant="large" style={styles.userName}>
            ...
            <Card style={styles.formCard}>
                ...
                <CardContent style={styles.formContent}>
                    ...
                    <View style={styles.inputGroup}>
                        <Text variant="small" style={styles.label}>Documento</Text>
                        <Input
